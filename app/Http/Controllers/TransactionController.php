...
class TransactionController extends Controller
{
    ...
    public function index()
    {
        ...
        $products=DB::table('transaction')->join('posts','transaction.id_produk','=','posts.id')->select('transaction.id','id_produk','jumlah','name','description','price','weight','cover_image','transaction.created_at')->where('id_user','=',$user_id)->orderBy('created_at','asc')->paginate(3);
